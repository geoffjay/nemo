...
* [Build system](build-system.md) - a `nemo build` command with a `nemo.toml` manifest, compiled `.nemo` component artifacts, opt-in `dist/` project builds, and Go-style remote component libraries; expands and supersedes SFC "Phase 5". Phase 0 implemented (manifest, project-root discovery, `nemo build` dry-run skeleton); Phases 1–3 pending.
