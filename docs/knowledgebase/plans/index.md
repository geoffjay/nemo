...
* [Build system](build-system.md) - a `nemo build` command with a `nemo.toml` manifest, compiled `.nemo` component artifacts, opt-in `dist/` project builds, and Go-style remote component libraries; expands and supersedes SFC "Phase 5". Not yet implemented.
